...
func TestClientAskStreamsEvents(t *testing.T) {
	...
	server := httptest.NewServer(http.HandlerFunc(func(response http.ResponseWriter, request *http.Request) {
		if request.Method != http.MethodPost || request.URL.Path != askPath {
...
func TestClientAskRejectsRedirect(t *testing.T) {
...
func TestClientAskRejectsMalformedOrIncompleteStream(t *testing.T) {
